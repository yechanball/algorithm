...
public class Main_24482_알고리즘수업_깊이우선탐색4 {
	static int N, M, R; // N:정점의 개수, M:간선의 개수, R:탐색을 시작할 정점의 번호, depth: 깊이
	...
	public static void dfs(int curr, int depth) { // DFS 재귀 메서드
