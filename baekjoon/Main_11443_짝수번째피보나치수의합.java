...
public class Main_11443_짝수번째피보나치수의합 {
	...
	public static void main(String[] args) throws IOException {
		...
		long evenSumN; // 0번 항부터 2N번째 항까지 짝수번째 항 합은 2N+1번째 피보나치 수 - 1과 같음

		if(N%2 == 0) { // N이 짝수인 경우 -> N+1번째 항 - 1이 합과 동일
			evenSumN = squared(A, N)[0][0] - 1; // N+1번째 피보나치 수			
		}else { // N이 홀수인 경우 -> N번째 항 - 1이 합과 동일
			evenSumN = squared(A, N-1)[0][0] - 1; // N번째 피보나치 수						
		}
		System.out.print(evenSumN);
	}
